...
select case Request.QueryString("mode")
	case "AIM"
		...
		Response.Write	"      <p><font face=""" & strDefaultFontFace & """ size=""" & strHeaderFontSize & """>" & strProfileName & "'s AIM Options</font></p>" & vbNewLine & _
				"      <p align=""center""><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """><b>NOTE:</b> You must have AOL Instant Messenger installed in order for these functions to work properly.</font></p>" & vbNewLine & _
				...
				"              <tr>" & vbNewLine & _
				"                <td bgColor=""" & strPopUpTableColor & """ align=""center"" nowrap><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """><a href=""aim:goIM?screenname=" & strAIM_Name & """ alt=""Opens a send message window to the user."">Send a Message</a></font></td>" & vbNewLine & _
				"              </tr>" & vbNewLine & _
				"              <tr>" & vbNewLine & _
				"                <td bgColor=""" & strPopUpTableColor & """ align=""center"" nowrap><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """><a href=""aim:goChat?ROOMname=" & strAIM_Name & """>Open a chat room</a></font></td>" & vbNewLine & _
				"              </tr>" & vbNewLine & _
				"              <tr>" & vbNewLine & _
				"                <td bgColor=""" & strPopUpTableColor & """ align=""center"" nowrap><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """><a href=""aim:addBuddy?screenname=" & strAIM_Name & """>Add to buddy list</a></font></td>" & vbNewLine & _
				"              </tr>" & vbNewLine & _
				"            </table>" & vbNewLine & _
				"          </td>" & vbNewLine & _
				"        </tr>" & vbNewLine & _
	...
	case "ICQ"
		...
		Response.Write	"      <p><font face=""" & strDefaultFontFace & """ size=""" & strHeaderFontSize & """>Send an ICQ Message</font></p>" & vbNewLine & _
				...
				"                <td bgColor=""" & strPopUpTableColor & """><input type=""text"" name=""from"" size=""20"" maxlength=""40"" style=""width:150px;"" onfocus=""this.select()""></td>" & vbNewLine & _
				"              </tr>" & vbNewLine & _ 
				"              <tr>" & vbNewLine & _
				...
				"                <td bgColor=""" & strPopUpTableColor & """><input type=""text"" name=""fromemail"" size=""20"" maxlength=""40"" style=""width:150px;"" onfocus=""this.select()""></td>" & vbNewLine & _
				"              </tr>" & vbNewLine & _
	...
	case "MSN"
		...
		Response.Write	"      <p align=""center""><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """><b>" & strProfileName & "'s MSN Messenger address:</b><br /><br /><br /><script language=""javascript"" type=""text/javascript"">MSNjs()</script></p><br /><br />" & vbNewLine
		rsMSN.close
		set rsMSN = nothing
end select
