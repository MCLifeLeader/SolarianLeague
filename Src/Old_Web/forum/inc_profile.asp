		...
		if (strBio + strHobbies + strLNews + strQuote)	> 0 then 
			...
			if strQuote = "1" then
				Response.Write	"                    <tr>" & vbNewLine & _
						...
						"                      <td bgColor=""" & strPopUpTableColor & """ valign=""top""><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """><textarea name=""Quote"" cols=""30"" rows=""4"">" & Trim(cleancode(strMyQuote)) & "</textarea></font></td>" & vbNewLine & _
						"                    </tr>" & vbNewLine
			end if
			if strBio = "1" then
				Response.Write	"                    <tr>" & vbNewLine & _
