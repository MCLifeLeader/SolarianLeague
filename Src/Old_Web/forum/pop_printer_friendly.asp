...
Response.Write	"    <a href=""javascript:onClick=window.print()"">Print Page</a> | <a href=""JavaScript:onClick=window.close()"">Close Window</a></font><br />" & vbNewline & _
		...
		"    <p align=""left""><font face=""" & strDefaultFontFace & """ size=""" & strHeaderFontSize & """><b>" & chkString(rs4("T_SUBJECT"),"display") & "</b></font></p>" & vbNewline & _
		"    <p align=""left""><b>Printed from:</b> " & strForumTitle & "<br />" & vbNewline & _
...
Response.Write	"    <p align=""left""><hr></p>" & vbNewline & _
		"    <p align=""left""><b>" & strForumTitle & " </b>: <a href=""" & strForumURL & """>" & strForumURL & "</a></p>" & vbNewline & _
		"    <p align=""left""><b>&copy; " & strCopyright & "</b></font></p>" & vbNewline &_
		"    </td>" & vbNewline & _
		"  </tr>" & vbNewline & _
		"  <tr>" & vbNewline & _
