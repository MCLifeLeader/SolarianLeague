...
Response.Write	"</p>" & vbNewLine & _
		...
		"                  <td bgcolor=""" & strForumCellColor & """>" & vbNewLine & _
		"                  <p><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """ color=""" & strForumFontColor & """>" & vbNewLine & _
		"                  You may edit or delete your own posts at any time. Just go to the topic where the post to be edited or deleted is located and you will see an edit or delete icon (" & getCurrentIcon(strIconEditTopic,"Edit","align=""absmiddle"" hspace=""6""") & getCurrentIcon(strIconDeleteReply,"Delete","align=""absmiddle"" hspace=""6""") & ") on the line that begins &quot;posted on...&quot; Click on this icon to edit or delete the post. No one else can edit your post, except for the forum Moderator or the forum Administrator. "
...
Response.Write	"               <tr>" & vbNewLine & _
		...
		"               <tr>" & vbNewLine & _
		"                 <td bgcolor=""" & strForumCellColor & """><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """ color=""" & strForumFontColor & """>" & vbNewLine & _
		"                 <p>The most recent version of this Snitz Forum can be downloaded at <span class=""spnMessageText""><a href=""http://forum.snitz.com/"" target=""_blank"" title=""Link to Snitz Forums 2000 Homepage!"">this Internet web site</a></span>.</p>" & vbNewLine & _
		"                 <p>NOTE: The software is highly configurable, and the baseline Snitz Forum may not have all the features this forum does.</p></font></td>" & vbNewLine & _
		"               </tr>" & vbNewLine & _
		"             </table>" & vbNewLine & _
		"           </td>" & vbNewLine & _
		"         </tr>" & vbNewLine & _
