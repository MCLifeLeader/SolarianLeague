...
if strProhibitNewMembers = "1" then
	...
	Response.Write	"<acronym title=""Click here to register.""><span class=""spnMessageText""><a href=""register.asp""" & dWStatus("Click here to register.") & ">Register Here!</a></span></acronymn></font></td>" & vbNewLine
end if
Response.Write	"                    </tr>" & vbNewLine & _
		"                  </table>" & vbNewLine & _
		"                </td>" & vbNewLine & _
