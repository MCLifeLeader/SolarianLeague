...
if strAction = "approve" then
	if selID = "-1" then
		...
		Response.Write	"      <br /><p align=""center""><font face=""" & strDefaultFontFace & """ size=""" & strHeaderFontSize & """><b>Members Approved!</b></font></p>" & vbNewLine & _
				...
				"      <p align=""center""><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """>All Pending Members have been approved! Their registration e-mails have been sent to them.</font></p>" & vbNewLine & _
		...
		Response.Write	"      <br /><p align=""center""><font face=""" & strDefaultFontFace & """ size=""" & strHeaderFontSize & """><b>Members Approved!</b></font></p>" & vbNewLine & _
				"      <meta http-equiv=""Refresh"" content=""5; URL=admin_accounts_pending.asp" & strPage & """>" & vbNewLine & _
				"      <p align=""center""><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """>Selected Pending Members have been approved! Their registration e-mails have been sent to them.</font></p>" & vbNewLine & _
				"      <p align=""center""><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """><a href=""admin_accounts_pending.asp" & strPage & """>Back To Members Pending</font></a></p><br />" & vbNewLine
		WriteFooter
		Response.End
	end if
...
if iMemberCount = "" then  '## No members found in DB
	...
	for iMember = 0 to iMemberCount
		...
		Response.Write	"              <tr>" & vbNewLine & _
				...
				"                <td bgcolor=""" & CColor & """ align=""center""><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """ color=""" & strForumFontColor & """><a href=""http://samspade.org/whois/" & ChkString(MP_MemberIP, "display") & """ target=""_blank"">" & MP_MemberIP & "</a></font></td>" & vbNewLine & _
