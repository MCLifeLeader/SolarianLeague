	...
	Case Else
		...
		if iBadwordCount = "" then
			if strBadWordFilter = 1 then
				...
				Response.Write "<p align=""center""><font face=""" & strDefaultFontFace & """ color=""" & strForumFontColor & """ size=""" & strDefaultFontSize & """ valign=""top"">Bad Word Filter feature is turned <b>Off</b>.</font></p>"
			end if
		elseif iBadwordCount = 0 then
			if strBadWordFilter = 0 then
				...
				Response.Write "<p align=""center""><font face=""" & strDefaultFontFace & """ color=""" & strForumFontColor & """ size=""" & strDefaultFontSize & """ valign=""top"">Bad Word Filter feature is turned <b>On</b>.</font></p>"
			end if
		end if
